<template>
  <div class="home">
    <div class="video">
      <video autoplay="autoplay" muted="muted" class="video-intro__video">
     ...
     <div class="main-container" >
      ...
      <b-row class="timeline">
        <b-col lg="10" offset="1">
          <div class="custom-timeline" >
            <div class="dot-time first active">1</div>
            <div class="dot-time second" v-bind:class="progress > 66 ? 'active' : '' ">2</div>
            <div class="dot-time third" v-bind:class="progress === 100 ? 'active' : '' "><b-icon stacked icon="check"></b-icon></div>
            <b-progress height="3px" :value="progress"></b-progress>
          </div>
        </b-col>
      </b-row>
    </div>
...
<script>
  import LineNet from "@/components/LineNet.vue";
